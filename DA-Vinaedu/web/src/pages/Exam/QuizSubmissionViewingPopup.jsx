...
function QuizSubmissionViewingPopup({ onClose, visible, exam, submission }) {
      ...
      <div class="w-screen max-w-screen-sm p-6">
        <div class="max-h-[90vh] overflow-auto bg-gray-100 rounded-lg p-4">
          <div class="flex justify-between items-center mb-2">
            ...
            <Show
              when={submission()?.grade != null && exam()?.questions.length}>
              <p class="font-semibold text-green-600">
                {(submission().grade * exam().questions.length) / 10} /{' '}
