...
function SubmissionPopup({
  ...
  const { students, setAssignments } = useClassroom();
        ...
        <div
          ...
          <div class="relative bg-white rounded-lg p-6 max-h-[90vh] overflow-auto">
            ...
            <div class="overflow-x-auto">
              <Show
                when={assignment()?.submissions.length}
                fallback={
                ...
                <table class="min-w-full">
                  ...
                  <tbody>
                    <For each={assignment().submissions}>
                      {(submission, index) => {
                        ...
                        return (
                          <tr
                            class={`${
                              assignment().submissions.length == index() + 1
                                ? ''
                                : 'border-b'
                            }`}>
                            ...
                            <td class="px-4 py-2 text-center">
                              <div
                                ...
                                <Show when={!isEditGrade()}>
                                  <p>{submission.grade?.formatFloat() ?? '--'}</p>
                                  <button
