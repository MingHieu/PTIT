function PrivacyPolicy() {
  return (
    <div className="pt-28 max-w-screen-xl mx-auto p-4 space-y-6">
      <h1 className="text-4xl font-bold text-gray-900">Privacy Policy</h1>
      <p className="text-sm text-gray-500">Last updated: November 22, 2024</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to VinaEdu.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to VinaEdu, accessible from{' '}
            <a
              href="https://vinaedu.id.vn"
      ...
      <ul>
        <li>By email: vinaedu.id.vn@gmail.com</li>
      </ul>
    </div>
  );
}
